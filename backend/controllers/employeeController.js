...
exports.createEmployee = async (req, res) => {
  ...
  try {
      ...
      res.status(201).json({ success: "Employee created successfully", savedEmployee });
  } catch (error) {
      res.status(500).json({ message: 'An error occurred while creating the employee', error});
  }
};
